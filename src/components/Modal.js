        ...
        <div className="relative bg-white rounded-lg  shadow dark:bg-gray-700">
          ...
          <div className='overflow-y-auto overflow-x-hidden'>
            <div className="p-6 space-y-6 flex justify-center">
                <img width={500} src={cocktailData.strDrinkThumb} alt={cocktailData.strDrink}></img>
            </div>
            ...
            <div className="p-6 space-y-6">
              <ul>
                {Object.entries(cocktailData).filter(([key,value]) => key.includes("strIngredient")&&(value!==null)).map(([key,value]) => <li key={value}>{value}</li> )}
              </ul>
            </div>
            <div className="flex justify-between overflow-y-auto items-start p-5 border-b border-t dark:border-gray-600">
                <h3 className="text-xl font-semibold text-gray-900 lg:text-2xl dark:text-white">
